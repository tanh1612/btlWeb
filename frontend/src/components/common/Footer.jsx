          ...
          <div className="row mb-3">
            <div className="col-md-3 mb-4">
              ...
              <div className="pt-3 pe-5">
                Premium quality apparel designed for your everyday comfort and
                style. Elevate your wardrobe with Pure Wear.
              </div>
            </div>
            <div className="col-md-3 mb-4">
            ...
            <div className="col-md-3 mb-4">
              ...
              <ul>
                <li>
                  <a href="">+84 962220942</a>
                </li>
                <li>
                  <a href="">+84 385787868</a>
                </li>
              </ul>
            </div>
          </div>
          <div className="row spotlight py-5">
            <div className="col-md-4">
              <div className="d-flex justify-content-center py-3">
                ...
                <h3 className="mb-0 ps-2">Free Delivery</h3>
              </div>
            </div>
            <div className="col-md-4">
              <div className="d-flex justify-content-center py-3">
                ...
                <h3 className="mb-0 ps-2">Refund Guarantee</h3>
              </div>
            </div>
            <div className="col-md-4">
              <div className="d-flex justify-content-center py-3">
                ...
                <h3 className="mb-0 ps-2">Secure Payment</h3>
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-md-12 text-center py-5">
              <p className="mb-0">&copy; 2024 All Right Reserved</p>
            </div>
          </div>
        </div>
      </footer>
